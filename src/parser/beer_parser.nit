...
module beer_parser is no_warning("missing-doc","old-init")
...
private fun reduce_Nprog(parser: Parser) do
...
private fun reduce_Nvolunit(parser: Parser) do
...
private fun reduce_Ntmpunit(parser: Parser) do
...
private fun reduce_Ngrvunit(parser: Parser) do
...
private fun reduce_Ncolunit(parser: Parser) do
...
private fun reduce_Nweiunit(parser: Parser) do
...
private fun reduce_Ntimunit(parser: Parser) do
...
private fun reduce_Nrecipe(parser: Parser) do
...
private fun reduce_Nrecipe_body_volume_95d0(parser: Parser) do
...
private fun reduce_Nrecipe_body_volume_95d1(parser: Parser) do
...
private fun reduce_Nrecipe_body_mash_temp_95d0(parser: Parser) do
...
private fun reduce_Nrecipe_body_mash_temp_95d1(parser: Parser) do
...
private fun reduce_Nequipment(parser: Parser) do
...
private fun reduce_Nequipment_body_volume_95d0(parser: Parser) do
...
private fun reduce_Nequipment_body_volume_95d1(parser: Parser) do
...
private fun reduce_Nequipment_body_efficiency_95d0(parser: Parser) do
...
private fun reduce_Nequipment_body_efficiency_95d1(parser: Parser) do
...
private fun reduce_Nfermentables(parser: Parser) do
...
private fun reduce_Ncompound_grain(parser: Parser) do
...
private fun reduce_Ncompound_adjunct(parser: Parser) do
...
private fun reduce_Ncompound_sugar(parser: Parser) do
...
private fun reduce_Ncompound_extract(parser: Parser) do
...
private fun reduce_Ncompound_body_potential_95d0(parser: Parser) do
...
private fun reduce_Ncompound_body_potential_95d1(parser: Parser) do
...
private fun reduce_Ncompound_body_colour_95d0(parser: Parser) do
...
private fun reduce_Ncompound_body_colour_95d1(parser: Parser) do
...
private fun reduce_Ncompound_body_quantity_95d0(parser: Parser) do
...
private fun reduce_Ncompound_body_quantity_95d1(parser: Parser) do
...
private fun reduce_Nhops(parser: Parser) do
...
private fun reduce_Nhop_profile(parser: Parser) do
...
private fun reduce_Nhop_profile_body_aa_95d0(parser: Parser) do
...
private fun reduce_Nhop_profile_body_aa_95d1(parser: Parser) do
...
private fun reduce_Nhop_profile_body_quantity_95d0(parser: Parser) do
...
private fun reduce_Nhop_profile_body_quantity_95d1(parser: Parser) do
...
private fun reduce_Nhop_profile_body_time_95d0(parser: Parser) do
...
private fun reduce_Nhop_profile_body_time_95d1(parser: Parser) do
...
private fun reduce_Nhop_profile_body_type_95d0(parser: Parser) do
...
private fun reduce_Nhop_profile_body_type_95d1(parser: Parser) do
...
private fun reduce_Nhop_profile_body_use_95d0(parser: Parser) do
...
private fun reduce_Nhop_profile_body_use_95d1(parser: Parser) do
...
private fun reduce_Nyeast(parser: Parser) do
...
private fun reduce_Nyeast_body_floc_95d0(parser: Parser) do
...
private fun reduce_Nyeast_body_floc_95d1(parser: Parser) do
...
private fun reduce_Nyeast_body_att_95d0(parser: Parser) do
...
private fun reduce_Nyeast_body_att_95d1(parser: Parser) do
...
private fun reduce_Nrecipe_body_43d_one(parser: Parser) do
...
private fun reduce_Nrecipe_body_43d_more(parser: Parser) do
...
private fun reduce_Nequipment_body_43d_one(parser: Parser) do
...
private fun reduce_Nequipment_body_43d_more(parser: Parser) do
...
private fun reduce_Ncompound_43d_one(parser: Parser) do
...
private fun reduce_Ncompound_43d_more(parser: Parser) do
...
private fun reduce_Ncompound_body_43d_one(parser: Parser) do
...
private fun reduce_Ncompound_body_43d_more(parser: Parser) do
...
private fun reduce_Nhop_profile_43d_one(parser: Parser) do
...
private fun reduce_Nhop_profile_43d_more(parser: Parser) do
...
private fun reduce_Nhop_profile_body_43d_one(parser: Parser) do
...
private fun reduce_Nhop_profile_body_43d_more(parser: Parser) do
...
private fun reduce_Nyeast_body_43d_one(parser: Parser) do
...
private fun reduce_Nyeast_body_43d_more(parser: Parser) do
...
redef class NToken
	...
	private fun action_srecipe_32dequipment_32dkw_fermentables_32dkw_adjunct_32dstring_32dcompound_body_43d(parser: Parser) do
		reduce_Ncompound_adjunct(parser)
	end
	...
	private fun action_srecipe_32dequipment_32dkw_fermentables_32dkw_extract_32dstring_32dcompound_body_43d(parser: Parser) do
		reduce_Ncompound_extract(parser)
	end
...
private class LRStatekw_recipe_32dstring_32drecipe_body
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Nrecipe_body_43d_one(parser)
	end
end
...
private class LRStaterecipe_32dequipment_32dkw_fermentables_32dcompound
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Ncompound_43d_one(parser)
	end
end
...
private class LRStaterecipe_32dkw_equipment_32dstring_32dequipment_body
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Nequipment_body_43d_one(parser)
	end
end
...
private class LRStatekw_recipe_32dstring_32drecipe_body_43d_32drecipe_body
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Nrecipe_body_43d_more(parser)
	end
end
# State kw_recipe string 'volume' ':'
...
private class LRStatekw_recipe_32dstring_32d_39dvolume_39d_32dvolunit
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Nrecipe_body_volume_95d1(parser)
	end
end
...
private class LRStatekw_recipe_32dstring_32d_39dmash_temp_39d_32dtmpunit
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Nrecipe_body_mash_temp_95d1(parser)
	end
end
...
private class LRStaterecipe_32dequipment_32dfermentables_32dkw_hops_32dhop_profile
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Nhop_profile_43d_one(parser)
	end
end
...
private class LRStaterecipe_32dequipment_32dkw_fermentables_32dcompound_43d_32dcompound
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Ncompound_43d_more(parser)
	end
end
...
private class LRStaterecipe_32dkw_equipment_32dstring_32dequipment_body_43d_32dequipment_body
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Nequipment_body_43d_more(parser)
	end
end
# State recipe kw_equipment string 'volume' ':'
...
private class LRStaterecipe_32dkw_equipment_32dstring_32d_39dvolume_39d_32dvolunit
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Nequipment_body_volume_95d1(parser)
	end
end
# State recipe kw_equipment string 'efficiency' ':'
...
private class LRStaterecipe_32dkw_equipment_32dstring_32d_39defficiency_39d_32dnumber
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Nequipment_body_efficiency_95d1(parser)
	end
end
# State kw_recipe string 'volume' ':' volunit
private class LRStatekw_recipe_32dstring_32d_39dvolume_39d_32d_39d_58d_39d_32dvolunit
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Nrecipe_body_volume_95d0(parser)
	end
end
...
private class LRStatekw_recipe_32dstring_32d_39dmash_temp_39d_32d_39d_58d_39d_32dtmpunit
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Nrecipe_body_mash_temp_95d0(parser)
	end
end
...
private class LRStaterecipe_32dequipment_32dfermentables_32dkw_hops_32dhop_profile_43d_32dhop_profile
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Nhop_profile_43d_more(parser)
	end
end
...
private class LRStaterecipe_32dequipment_32dkw_fermentables_32dkw_grain_32dstring_32dcompound_body
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Ncompound_body_43d_one(parser)
	end
end
...
private class LRStaterecipe_32dkw_equipment_32dstring_32d_39dvolume_39d_32d_39d_58d_39d_32dvolunit
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Nequipment_body_volume_95d0(parser)
	end
end
# State recipe kw_equipment string 'efficiency' ':' number
private class LRStaterecipe_32dkw_equipment_32dstring_32d_39defficiency_39d_32d_39d_58d_39d_32dnumber
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Nequipment_body_efficiency_95d0(parser)
	end
end
...
private class LRStaterecipe_32dequipment_32dfermentables_32dhops_32dkw_yeast_32dstring_32dyeast_body
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Nyeast_body_43d_one(parser)
	end
end
...
private class LRStaterecipe_32dequipment_32dfermentables_32dkw_hops_32dkw_hop_32dstring_32dhop_profile_body
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Nhop_profile_body_43d_one(parser)
	end
end
...
private class LRStaterecipe_32dequipment_32dkw_fermentables_32dkw_grain_32dstring_32dcompound_body_43d_32dcompound_body
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Ncompound_body_43d_more(parser)
	end
end
# State recipe equipment kw_fermentables kw_grain string 'potential' ':'
...
private class LRStaterecipe_32dequipment_32dkw_fermentables_32dkw_grain_32dstring_32d_39dpotential_39d_32dgrvunit
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Ncompound_body_potential_95d1(parser)
	end
end
...
private class LRStaterecipe_32dequipment_32dkw_fermentables_32dkw_grain_32dstring_32d_39dcolour_39d_32dcolunit
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Ncompound_body_colour_95d1(parser)
	end
end
...
private class LRStaterecipe_32dequipment_32dkw_fermentables_32dkw_grain_32dstring_32d_39dquantity_39d_32dweiunit
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Ncompound_body_quantity_95d1(parser)
	end
end
...
private class LRStaterecipe_32dequipment_32dfermentables_32dhops_32dkw_yeast_32dstring_32dyeast_body_43d_32dyeast_body
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Nyeast_body_43d_more(parser)
	end
end
# State recipe equipment fermentables hops kw_yeast string 'flocculation' ':'
...
private class LRStaterecipe_32dequipment_32dfermentables_32dhops_32dkw_yeast_32dstring_32d_39dflocculation_39d_32dflocculation_type
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Nyeast_body_floc_95d1(parser)
	end
end
# State recipe equipment fermentables hops kw_yeast string 'attenuation' ':'
...
private class LRStaterecipe_32dequipment_32dfermentables_32dhops_32dkw_yeast_32dstring_32d_39dattenuation_39d_32dnumber
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Nyeast_body_att_95d1(parser)
	end
end
...
private class LRStaterecipe_32dequipment_32dfermentables_32dkw_hops_32dkw_hop_32dstring_32dhop_profile_body_43d_32dhop_profile_body
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Nhop_profile_body_43d_more(parser)
	end
end
# State recipe equipment fermentables kw_hops kw_hop string 'alpha' ':'
...
private class LRStaterecipe_32dequipment_32dfermentables_32dkw_hops_32dkw_hop_32dstring_32d_39dalpha_39d_32dnumber
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Nhop_profile_body_aa_95d1(parser)
	end
end
# State recipe equipment fermentables kw_hops kw_hop string 'quantity' ':'
...
private class LRStaterecipe_32dequipment_32dfermentables_32dkw_hops_32dkw_hop_32dstring_32d_39dquantity_39d_32dweiunit
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Nhop_profile_body_quantity_95d1(parser)
	end
end
# State recipe equipment fermentables kw_hops kw_hop string 'time' ':'
...
private class LRStaterecipe_32dequipment_32dfermentables_32dkw_hops_32dkw_hop_32dstring_32d_39dtime_39d_32dtimunit
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Nhop_profile_body_time_95d1(parser)
	end
end
...
private class LRStaterecipe_32dequipment_32dfermentables_32dkw_hops_32dkw_hop_32dstring_32d_39dtype_39d_32dhop_type
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Nhop_profile_body_type_95d1(parser)
	end
end
# State recipe equipment fermentables kw_hops kw_hop string 'use' ':'
...
private class LRStaterecipe_32dequipment_32dfermentables_32dkw_hops_32dkw_hop_32dstring_32d_39duse_39d_32dhop_use
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Nhop_profile_body_use_95d1(parser)
	end
end
# State recipe equipment kw_fermentables kw_grain string 'potential' ':' grvunit
private class LRStaterecipe_32dequipment_32dkw_fermentables_32dkw_grain_32dstring_32d_39dpotential_39d_32d_39d_58d_39d_32dgrvunit
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Ncompound_body_potential_95d0(parser)
	end
end
...
private class LRStaterecipe_32dequipment_32dkw_fermentables_32dkw_grain_32dstring_32d_39dcolour_39d_32d_39d_58d_39d_32dcolunit
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Ncompound_body_colour_95d0(parser)
	end
end
...
private class LRStaterecipe_32dequipment_32dkw_fermentables_32dkw_grain_32dstring_32d_39dquantity_39d_32d_39d_58d_39d_32dweiunit
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Ncompound_body_quantity_95d0(parser)
	end
end
...
private class LRStaterecipe_32dequipment_32dfermentables_32dhops_32dkw_yeast_32dstring_32d_39dflocculation_39d_32d_39d_58d_39d_32dflocculation_type
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Nyeast_body_floc_95d0(parser)
	end
end
# State recipe equipment fermentables hops kw_yeast string 'attenuation' ':' number
private class LRStaterecipe_32dequipment_32dfermentables_32dhops_32dkw_yeast_32dstring_32d_39dattenuation_39d_32d_39d_58d_39d_32dnumber
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Nyeast_body_att_95d0(parser)
	end
end
# State recipe equipment fermentables kw_hops kw_hop string 'alpha' ':' number
private class LRStaterecipe_32dequipment_32dfermentables_32dkw_hops_32dkw_hop_32dstring_32d_39dalpha_39d_32d_39d_58d_39d_32dnumber
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Nhop_profile_body_aa_95d0(parser)
	end
end
# State recipe equipment fermentables kw_hops kw_hop string 'quantity' ':' weiunit
private class LRStaterecipe_32dequipment_32dfermentables_32dkw_hops_32dkw_hop_32dstring_32d_39dquantity_39d_32d_39d_58d_39d_32dweiunit
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Nhop_profile_body_quantity_95d0(parser)
	end
end
# State recipe equipment fermentables kw_hops kw_hop string 'time' ':' timunit
private class LRStaterecipe_32dequipment_32dfermentables_32dkw_hops_32dkw_hop_32dstring_32d_39dtime_39d_32d_39d_58d_39d_32dtimunit
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Nhop_profile_body_time_95d0(parser)
	end
end
...
private class LRStaterecipe_32dequipment_32dfermentables_32dkw_hops_32dkw_hop_32dstring_32d_39dtype_39d_32d_39d_58d_39d_32dhop_type
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Nhop_profile_body_type_95d0(parser)
	end
end
# State recipe equipment fermentables kw_hops kw_hop string 'use' ':' hop_use
private class LRStaterecipe_32dequipment_32dfermentables_32dkw_hops_32dkw_hop_32dstring_32d_39duse_39d_32d_39d_58d_39d_32dhop_use
	...
	redef fun error_msg do return ""
	redef fun action(parser) do
		reduce_Nhop_profile_body_use_95d0(parser)
	end
end
